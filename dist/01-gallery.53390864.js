...
function renderImage(gallery) {
    return gallery.reduce((acc, { original , preview , description  })=>acc + `
...
galleryRef.insertAdjacentHTML("beforeend", renderImage((0, _galleryItems.galleryItems)));
function handleCleck(e) {
    ...
    gallery.on("show.simplelightbox", function() {
        ...
        function onCloseView(event) {
            if (event.key === "Escape") gallery.on("close.simplelightbox", function() {
            // Do something…
            });
